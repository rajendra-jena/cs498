function generateLineChart(dataset, xName, yNames) {
    /*
    ...
    var colorFunct = d3.scaleOrdinal(d3.schemeCategory10);
    ...
    chart.xFormatter = chart.formatAsYear;
    ...
    chart.bind = function (bindOptions) {
        ...
        */
        ...
        chart.objs.yAxis = d3.axisLeft().scale(chart.yScale).tickFormat(chart.yFormatter); 
    ...
    chart.render = function () {
        ...
        function mouseHover() {
            ...
            for (yName in chart.groupObjs) {
                ...
                console.log('cy' + cY.yFunct(d) + yName);
